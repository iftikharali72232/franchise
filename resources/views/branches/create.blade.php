        ...
        <form action="{{ route('branches.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid md:grid-cols-4 grid-cols-1 gap-4">
                    ...
                    <div class="">
                        ...
                        <input type="email" name="owner_email" class="w-full px-6 py-3 border border-[#1F5077] bg-[#D6E7F5] text-[#1F5077] focus:bg-[#D6E7F5]/30 focus:border-[#1F5077]/70 focus:outline-none rounded-full" placeholder="Example" />
                    </div>
                    <div class="">
