                    ...
                    <div class="mb-4 question-item">
                        ...
                        <div class="grid md:grid-cols-3 gap-4 p-4">
                            <div class="">
                                ...
                                <input type="text" name="questions[0][answer1]" class="bg-transparent focus:outline-none focus:border-b focus:border-gray-200" placeholder="{{ trans('lang.example') }}" disabled value="Excellent">
                            </div>
                            <div class="">
                                <label for="questions[0][answer2]" class="form-label w-auto me-3">{{ trans('lang.answer2') }}</label>
                                <input type="text" name="questions[0][answer2]" class="bg-transparent focus:outline-none focus:border-b focus:border-gray-200" placeholder="{{ trans('lang.example') }}" disabled value="Average">
                            </div>
                            <div class="">
                                <label for="questions[0][answer3]" class="form-label w-auto me-3">{{ trans('lang.answer3') }}</label>
                                <input type="text" name="questions[0][answer3]" class="bg-transparent focus:outline-none focus:border-b focus:border-gray-200" placeholder="{{ trans('lang.example') }}" disabled value="Unacceptable">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-4 question-item">
                ...
                <div class="grid grid-cols-3 gap-4 p-4">
                    <div class="">
                        ...
                        <input type="text" name="questions[${questionIndex}][answer1]" class="bg-transparent focus:outline-none focus:border-b focus:border-gray-200" placeholder="{{ trans('lang.example') }}" disabled value="Excellent">
                    </div>
                    <div class="">
                        <label for="questions[${questionIndex}][answer2]" class="form-label w-auto me-3">{{ trans('lang.answer2') }}</label>
                        <input type="text" name="questions[${questionIndex}][answer2]" class="bg-transparent focus:outline-none focus:border-b focus:border-gray-200" placeholder="{{ trans('lang.example') }}" disabled value="Average">
                    </div>
                    <div class="">
                        <label for="questions[${questionIndex}][answer3]" class="form-label w-auto me-3">{{ trans('lang.answer3') }}</label>
                        <input type="text" name="questions[${questionIndex}][answer3]" class="bg-transparent focus:outline-none focus:border-b focus:border-gray-200" placeholder="{{ trans('lang.example') }}" disabled value="Unacceptable">
                    </div>
                </div>
            </div>
        `;
